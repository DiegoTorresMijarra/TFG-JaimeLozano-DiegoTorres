package es.jaimelozanodiegotorres.backapp.rest.auth.controller;
...
import es.jaimelozanodiegotorres.backapp.rest.auth.service.authentication.AuthenticationService;
...
class AuthenticationRestControllerTest {
    private final String myEndpoint = "http://localhost:3000/auth";
