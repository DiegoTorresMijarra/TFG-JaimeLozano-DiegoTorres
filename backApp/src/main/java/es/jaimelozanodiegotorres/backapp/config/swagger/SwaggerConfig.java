package es.jaimelozanodiegotorres.backapp.config.swagger;
...
class SwaggerConfig {
    ...
    private final String linkRepositorio="https://github.com/DiegoTorresMijarra/TFG-JaimeLozano-DiegoTorres";
    ...
    GroupedOpenApi httpApi() {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/**")
                .displayName("API MacJavaServer Spring Boot DAW 2024")
                .build();
    }
}