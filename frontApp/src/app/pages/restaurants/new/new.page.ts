...
import {Restaurant, RestaurantDto, RestaurantService} from "../../../services/restaurant.service";
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonItem, IonLabel, IonInput, IonText, IonNote, IonButton, ReactiveFormsModule]
})
