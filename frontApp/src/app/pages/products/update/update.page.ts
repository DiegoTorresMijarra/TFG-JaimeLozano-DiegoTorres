...
import {
    ...
    IonInput,
    IonItem,
    IonLabel, IonNote, IonSelect, IonSelectOption, IonText,
    IonTitle, IonToggle,
    IonToolbar
...
@Component({
  ...
  standalone: true,
    imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonButton, IonInput, IonItem, IonLabel, IonNote, IonSelect, IonSelectOption, IonText, IonToggle, ReactiveFormsModule]
})
