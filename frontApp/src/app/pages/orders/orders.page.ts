...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonButton, IonButtons, IonIcon, IonItem, IonLabel, IonList, IonItemDivider]
})
export class OrdersPage implements OnInit {
  ...
  loadOrders() {
    this.orderService.getOrders().subscribe((data) => {
      ...
      this.orders.forEach(order => order.orderedProducts.forEach(product => this.getProduct(product.productId)));
    })
  }
