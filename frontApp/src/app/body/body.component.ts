...
import {bagOutline, bagSharp, restaurantOutline, restaurantSharp} from "ionicons/icons";
...
export class BodyComponent {
  ...
  constructor() {addIcons({ bagOutline, bagSharp, restaurantOutline, restaurantSharp }); }
